    ...
    <AppShell>
      <div className="grid min-w-0 gap-5 sm:gap-7">
        ...
        <section className="grid min-w-0 gap-4 rounded-app border border-white/10 bg-white/[0.06] p-3 sm:p-5">
          ...
          <LeaderboardRaceGraph rows={familyRows} title="Verifiably Eric's Favorite Family" />
        ...
        <section className="grid min-w-0 gap-4 rounded-app border border-white/10 bg-white/[0.06] p-3 sm:p-5">
          ...
          <LeaderboardRaceGraph rows={friendRows} title="Verifiably Eric's Favorite Friends" />
