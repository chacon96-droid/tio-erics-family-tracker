    ...
    <main className="grid min-h-screen place-items-center bg-paper p-4">
      <form action={requestPasswordReset} className="w-full max-w-sm rounded-app border border-line bg-white p-5">
        ...
        <p className="mt-2 text-sm font-semibold text-muted">
          Enter your email and I’ll send recovery instructions. If you are Eric, that means a temporary admin password. Very official. Slightly less fun than remembering things.
        </p>
        ...
        {params?.sent ? (
          <p className="mt-3 rounded-app bg-green-50 p-3 text-sm font-bold text-green-800">
            Recovery email sent to {params.sent}. Check your email on this phone and follow the instructions.
          </p>
        ) : null}
        ...
        <button className="focus-ring mt-5 w-full rounded-app bg-ink px-4 py-3 font-black text-white">Send recovery email</button>
